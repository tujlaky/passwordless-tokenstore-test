		...
		describe('Tests', function() {
			...
			describe('authenticate()', function() {
				...
				it('should throw exceptions for missing data', function () {
					...
					expect(function() { store.authenticate(uuid.v4(), '', function() {})}).toThrowError();
					expect(function() { store.authenticate(uuid.v4(), chance.email()) }).toThrowError();
					expect(function() { store.authenticate(uuid.v4()) }).toThrowError();
				})
